...
class RecursiveSelectionSortTest extends TestSpec {
  import RecursiveSelectionSort.{recSelectionSort => selectionSort}
  
  "Recursive Selection Sort" should "sort an empty array" in {
